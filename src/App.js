  ...
  const runACO = async () => {
    ...
    if (useApi) {
      try {
        ...
        alert('Failed to connect to Python backend. Make sure Flask server is running on port 5000.');
        setIsRunning(false);
      }
    } else {
