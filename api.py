...
def ant_colony_optimization(distance_matrix, weather_map, n_ants=3, n_iterations=10, 
    ...
    return best_path, float(best_length), iteration_data, city_demand, total_supply
...
def solve_tsp():
    ...
    try:
        ...
        best_path, best_length, iteration_data, city_demand, total_supply = ant_colony_optimization(
